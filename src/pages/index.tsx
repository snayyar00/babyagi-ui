...
function Home() {
  ...
  return (
    <>
      <Head>
        <title>SmartGPT-UI</title>
        <meta
          name="description"
          content="GPT is designed to make it easier to run and develop with babyagi in a web app, like a ChatGPT."
        />
        ...
        <meta
          ...
          content=" is designed to make it easier to run and develop with babyagi in a web app, like a ChatGPT."
        />
